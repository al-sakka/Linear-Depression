  ...
  return (
    <div className="min-h-screen particle-bg flex items-center justify-center px-4">
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-2">Welcome to LinearMind</h1>
        <p className="text-foreground/50 text-sm mb-8">
          Sign in to track your progress, earn achievements, and learn Linear Regression interactively.
        </p>
